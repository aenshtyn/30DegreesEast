...
export default function TestimonialsCarousel({ stories }: TestimonialsCarouselProps) {
  ...
  return (
    <div className="relative">
      <div className="overflow-hidden rounded-[32px] border border-white/10 bg-white/5 p-2">
        ...
        >
          {stories.map((story) => (
            <article key={story.name} className="min-w-full px-2 py-6">
              <div className="rounded-[28px] border border-white/15 bg-raisin/90 p-8 shadow-soft-card">
